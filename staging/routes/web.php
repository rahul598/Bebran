...
Route::get('/purchase-next', [App\Http\Controllers\FrontendController::class, 'purchase_second'])->name('purchase_next'); // Change to purchase_next
Route::get('/thank-purchase/{id}', [App\Http\Controllers\FrontendController::class, 'thank'])->name('thank_page');



// Custome Route Staging
Route::get('/subscribe/{plan}', [SubscriptionController::class, 'showSubscriptionForm'])->name('subscribe.show');
...
Route::get('partials/desktop-banner', function () {
    ...
    $image = '';  // Replace with your logic to get the image path
    $page_id = 0;  // Replace with your logic to get the page ID
    $title = '';  // Replace with your logic to get the title
    $allServiceData = [];  // Replace with your logic to get service data
    $btn_text = '';  // Replace with your logic to get button text
    $first_body = '';  // Replace with your logic to get the first body content
