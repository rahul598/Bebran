...
<div class="innerbanner-area">  
    <div class="macbook-air-1">
        <section class="container">
            <div class="row "> 
    <ul class="nav nav-pills justify-content-center" id="exTab1">
        <div class="d-flex mb-5 border-new">
            <li class="nav-item"><a href="#a1" id="ex2-tab-1" class="nav-link text-black active duration" role="tab" aria-controls="#a1" aria-selected="false" data-bs-toggle="tab">1 Month</a></li>
            <li class="nav-item"><a href="#a2" id="ex2-tab-2" class="nav-link text-black duration" data-bs-toggle="tab" aria-controls="#a2" aria-selected="false">Quarterly</a></li>
            <li class="nav-item"><a href="#a3" id="ex2-tab-3" class="nav-link text-black duration" data-bs-toggle="tab" aria-controls="#a3" aria-selected="false">Half Yearly</a></li>
            <li class="nav-item"><a href="#a4" id="ex2-tab-4" class="nav-link text-black duration" data-bs-toggle="tab" aria-controls="#a4" aria-selected="false">Yearly</a></li>
        </div>
    </ul>
                ...
                <div class="box-bronze new_box">
                        ...
                        <div class="box-bronze-inner">
                            <div class="bronze-parent">
                                <div class="gold-parent">
                                    <h3 class="bronze">{{ $val['plan_name'] }}</h3>
                        ...
                        <div class="box-bronze-child">
                            <div class="frame-container">
                                @php $features = json_decode($val['small_features']); @endphp
        ...
        <div class="tab-pane  d-flex justify-content-between fade hide display_none" id="a2" aria-labelledby="ex2-tab-2" role="tabpanel">
            ...
            <div class="box-bronze new_box">
                ...
                <div class="box-bronze-inner">
                    <div class="bronze-parent">
                        <div class="gold-parent">
                            <h3 class="bronze">{{ $val1['plan_name'] }}</h3>
                ...
                <div class="rectangle-parent">
                    ...
                    <div class="accumsan-vel-purus-container">
                        <p class="accumsan-vel-purus">
                            {{ $val1['small_description'] }}
                        </p>
                    </div>
                </div>
                <div class="box-bronze-child">
                    <div class="frame-container">
                        @php $features = json_decode($val1['small_features']); @endphp
                        @foreach($features as $fea)
                        <div class="frame-parent1">
                            <div class="ture-mark-01-wrapper">
                                <img class="ture-mark-01-icon" loading="lazy" alt="" src="./public/ture-mark-01.svg" />
            ...
            @foreach($data2 as $key2 => $val2)  
                <div class="box-bronze new_box">
                        ...
                        <div class="box-bronze-inner">
                            <div class="bronze-parent">
                                <div class="gold-parent">
                                    <h3 class="bronze">{{ $val2['plan_name'] }}</h3>
                        ...
                        <div class="rectangle-parent">
                            ...
                            <div class="accumsan-vel-purus-container">
                                <p class="accumsan-vel-purus">
                                    {{ $val2['small_description'] }}
                                </p>
                            </div>
                        </div>
                        <div class="box-bronze-child">
                            <div class="frame-container">
                                @php $features = json_decode($val2['small_features']); @endphp
                                @foreach($features as $fea)
                                    <div class="frame-parent1">
                                        <div class="ture-mark-01-wrapper">
                                            <img class="ture-mark-01-icon" loading="lazy" alt="" src="./public/ture-mark-01.svg" />
        ...
        <div class="tab-pane  d-flex justify-content-between fade hide display_none" id="a4" aria-labelledby="ex2-tab-4" role="tabpanel">
            ...
            <div class="box-bronze new_box">
                ...
                <div class="box-bronze-inner">
                    <div class="bronze-parent">
                        <div class="gold-parent">
                            <h3 class="bronze">{{ $val3['plan_name'] }}</h3>
                ...
                <div class="rectangle-parent">
                    ...
                    <div class="accumsan-vel-purus-container">
                        <p class="accumsan-vel-purus">
                            {{ $val3['small_description'] }}
                        </p>
                    </div>
                </div>
                <div class="box-bronze-child">
                    <div class="frame-container">
                        @php $features = json_decode($val3['small_features']); @endphp
                        @foreach($features as $fea)
                        <div class="frame-parent1">
                            <div class="ture-mark-01-wrapper">
                                <img class="ture-mark-01-icon" loading="lazy" alt="" src="./public/ture-mark-01.svg" />
...
<script> 
    $(document).ready(function() {
        $('.duration').on('click', function() { 
            ...
            $('.tab-pane').not(tabId).removeClass('show active').addClass('hide display_none');
