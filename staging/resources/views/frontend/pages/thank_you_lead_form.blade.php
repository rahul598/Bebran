...
@section('content') 
      ...
      <div class="thanksection">
         <div class="container">
            ...
            <ul>
               <li><a href="{{ $followLinks[0]->value }}" target="_blank"><img src="{{ asset('frontend/images/tyfacebook.webp') }}" alt=""></a></li>
               <li><a href="{{ $followLinks[2]->value }}" target="_blank"><img src="{{ asset('frontend/images/tylinkdin.webp') }}" alt=""></a></li>
               <li><a href="{{ $followLinks[1]->value }}" target="_blank"><img src="{{ asset('frontend/images/tytwitter.webp') }}" alt=""></a></li>
            </ul>
         </div>
         </div>
      </div>
