        ...
        <div class="main-comparisontable">
            <div class="p-0 overflow_x_scroll" style="padding-left: 20px !important;">
                <div class="scroll-container" id="browse-features">
                    <nav class="nav nav-pills justify-content-center mb-2"  role="tablist">
                        <ul class="nav mb-5">
                            <li class="nav-item">
                                <a href="#va11a" id="vwex22-tab-11" class="nav-link active text-black packages-box duration new_click_new" role="tab" aria-controls="a11a" aria-selected="true" data-bs-toggle="tab">Month
                                    <br>
                                    <span class="sub_title">1 Month</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="#va21a" id="vwex22-tab-21" class="nav-link text-black packages-box duration new_click_new" role="tab" aria-controls="a21a" aria-selected="false" data-bs-toggle="tab">Quarterly
                                    <br>
                                    <span class="sub_title">3 Month</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="#va31a" id="vwex22-tab-31" class="nav-link text-black packages-box duration new_click_new" role="tab" aria-controls="a31a" aria-selected="false" data-bs-toggle="tab">Half Yearly
                                    <br>
                                    <span class="sub_title">6 Month</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="#va41a" id="vwex22-tab-41" class="nav-link text-black packages-box duration new_click_new" role="tab" aria-controls="a41a" aria-selected="false" data-bs-toggle="tab">Yearly
                                    <br>
                            ...
                            <table class="price-table">
                                <tbody>
                                    <tr class="sticky-header">
                                        ...
                                        <td>
                                            <div class="litebox">
                                                <h3>{{ ucfirst($val['plan_name']) }}</h3>
                                                <div class="d-flex align-items-center justify-content-around">
                                                    <h5>₹{{ $val['main_price'] }}</h5>
                                                    <h4 class="save-30">Save {{ $val['percentage'] }}%</h4>
                                                </div>
                            ...
                            <table class="price-table">
                                <tbody>
                                    <tr class="sticky-header">
                                        ...
                                        <td>
                                            <div class="litebox">
                                                <h3>{{ ucfirst($val1['plan_name']) }}</h3>
                                                <div class="d-flex align-items-center justify-content-around">
                                                    <h5>₹{{ $val1['main_price'] }}</h5>
                                                    <h4 class="save-30">Save {{ $val1['percentage'] }}%</h4>
                                                </div>
                            ...
                            <table class="price-table">
                                <tbody>
                                    <tr class="sticky-header">
                                        ...
                                        <td>
                                            <div class="litebox">
                                                <h3>{{ ucfirst($val2['plan_name']) }}</h3>
                                                <div class="d-flex align-items-center justify-content-around">
                                                    <h5>₹{{ $val2['main_price'] }}</h5>
                                                    <h4 class="save-30">Save {{ $val2['percentage'] }}%</h4>
                                                </div>
                            ...
                            <table class="price-table">
                                <tbody>
                                    <tr class="sticky-header">
                                        ...
                                        <td>
                                            <div class="litebox">
                                                <h3>{{ ucfirst($val3['plan_name']) }}</h3>
                                                <div class="d-flex align-items-center justify-content-around">
                                                    <h5>₹{{ $val3['main_price'] }}</h5>
                                                    <h4 class="save-30">Save {{ $val3['percentage'] }}%</h4>
                                                </div>
