    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-3 fww">
          ...
          <div class="flogo"><img src="{!! $site_footer_logo !!}" alt="{!! config('site.title') !!}" width="170" height="56"></div>
        </div>
        <div class="col-lg-3 fww1">
            @if(config('site.footer2_title'))<h4>{!!config('site.footer2_title')!!}</h4>@endif
            @if(config('site.footer2_title1'))
            <h6><i class="fa fa-map-marker" aria-hidden="true"></i> {!!config('site.footer2_title1')!!}</h6>
            @endif
            @if(config('site.footer2_title6')) 
            <h6><i class="fa fa-map-marker" aria-hidden="true"></i> {!!config('site.footer2_title6')!!}</h6>
            @endif
            @if(config('site.footer2_title2'))
            <h6><i class="fa fa-phone" aria-hidden="true"></i><a href="tel:{!!preg_replace('/\D+/', '', config('site.footer2_title2'))!!}">{!!config('site.footer2_title2')!!}</a></h6>
            @endif
            @if(config('site.footer2_title7'))
            <h6><i class="fa fa-phone" aria-hidden="true"></i><a href="tel:{!!preg_replace('/\D+/', '', config('site.footer2_title7'))!!}">{!!config('site.footer2_title7')!!}</a></h6>
            @endif
            @if(config('site.footer2_title3'))
            <h6><i class="fa-solid fa-envelope"></i><a href="mailto:{!!config('site.footer2_title3')!!}">{!!config('site.footer2_title3')!!}</a></h6>
            @endif
            @if(config('site.footer2_title4'))
            <h6><i class="fa-brands fa-whatsapp"></i>
               <a href="https://wa.me/{{ $encodedPhoneNumber }}?text=Hi" target="_blank">{!!config('site.footer2_title4')!!}</a>
            </h6>  
            @endif
            @if(config('site.footer2_title5'))
            <h6><i class="fa fa-question-circle"></i>
               <a href="{!!config('site.footer2_title5')!!}" target="_blank">{!!config('site.footer2_title5')!!}</a>
            </h6>  
            @endif
            @if(config('site.footer2_title8'))
            <h6><i class="fa-brands fa-skype" aria-hidden="true"></i><a href="{!!config('site.footer2_title8')!!}" target="_blank">Skype</a></h6>
            @endif
        </div>
        <div class="col-lg-3 fww2">
          @if(config('site.footer3_title'))<h4>{!!config('site.footer3_title')!!}</h4>@endif
          <ul>
            <?php $active_menu = ''; ?>
        ...
        <div class="col-lg-3 fww3">
          @if(config('site.footer4_title'))<h4>{!!config('site.footer4_title')!!}</h4>@endif
          <ul>
            <?php $active_menu = ''; 
            // echo "<pre>";
        ...
        <div class="col-lg-3 fww4">
          @if(config('site.footer5_title'))<h4>{!!config('site.footer5_title')!!}</h4>@endif
          <ul>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-6 col-md-12 col-sm-12">
          ...
          <h5><span>Buy With Confidence:</span> 
  ...
  <div class="stykebox">
    <div class="container">
      <div class="d-flex align-items-center justify-content-between">
        ...
        <div class="colbox">
         <a href="https://wa.me/{{ $encodedPhoneNumber }}?text=Hi" target="_blank"><span><i class="fa-brands fa-whatsapp"></i></span>WhatsApp Only : {!!config('site.whatsapp')!!}</a>
        </div>
        @endif
      </div>
    </div>
