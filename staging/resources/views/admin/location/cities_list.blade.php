...
<div class="content-header">
   <div class="container-fluid">
      <div class="row mb-2">
         <div class="col-sm-6">
            <h1 class="m-0 text-dark">{{ __('Cities') }} <a href="{{ url(Admin_Prefix.'cities/add') }}" class="btn btn-primary">Add</a></h1>
         </div>
         <div class="col-sm-6">
         ...
         <div class="col-md-12">
            <div class="card">
               ...
               <div class="card-body table-responsive">
                  <table id="example2" class="table table-bordered table-hover dataTable">
                     ...
                     <tbody>
                        ...
                        <tr>
                           ...
                           @endforeach
                           <td>
                              <a href="{{ url(Admin_Prefix.'cities/edit/'.$list->city_id) }}" title="Edit" class="btn btn-success"><i class="fa fa-fw fa-edit"></i></a>
                              <a href="{{ url(Admin_Prefix.'cities/delete/'.$list->city_id) }}" data-confirm="" title="Delete" class="btn btn-danger"><i class="fa fa-fw fa-window-close"></i></a>
                           </td>
                        </tr>
                        @endforeach
                        @else
                  ...
                  {{$cities->appends(request()->input())->links("pagination::bootstrap-4")}}
               </div>
               <!-- /.card-body -->
            </div>
            <!-- /.card -->
