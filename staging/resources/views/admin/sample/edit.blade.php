...
@section('content')
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">{{ __('Edit Sample') }}</h1>
        </div>
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="{{url('admin')}}">{{ __('Home') }}</a></li>
            <li class="breadcrumb-item active">{{ __('Edit Sample') }}</li>
          </ol>
        </div>
      </div>
    </div>
    ...
    <div class="row"> 
      <div class="col-md-12">
        ...
        <div class="card card-primary">
          ...
          <!-- /.card-header -->
          <!-- form start -->
          <form role="form" action="{{ url(Admin_Prefix.'sample/update/') }}"  method="post" enctype="multipart/form-data" class="customValidate">
            ...
            <div class="card-body">
              ...
              <div class="form-group row clearfix bannerimage">
                ...
                <div class="col-sm-10">
                  ...
                  <div class="clearfix">
                    <?php
                    if($list->image2 && File::exists(public_path('uploads/'.$list->image2)) )
                      {
                        ?>
                        <img src="{{ asset('/uploads/'.$list->image2) }}" style="margin: 10px 0 0 0;max-width: 300px;">
                        <?php
                      }
                      ?>
                    </div>
