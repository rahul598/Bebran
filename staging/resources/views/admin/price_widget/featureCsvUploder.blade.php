...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0 text-dark">{{ __('Feature Uploader') }} </h1>
      </div>
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          <li class="breadcrumb-item btn btn-sm bg-primary text-dark"><a href="{{route('feature_list')}}">{{ __('Back') }}</a></li>
                    ...
                    <div class="card card_upload shadow">
                        ...
                        <div class=" body_upload">  
                            <div class="upload_content_bottom mb-2" style="bottom:40%">
                                <a href="{{ route('featureExistData') }}" class="btn secondColor">Features Data Download</a>
                            </div>
                            <div class="upload_content_bottom" style="bottom:25%">
                                <a href="{{ route('pricing_list_id') }}" class="btn secondColor">Download list of Features Service Id CSV</a>
                            </div>
                            <div class="upload_content_bottom" style="bottom:10% !important;">
                                <a id="sample_file" class="btn btn-sm box-shadow-4 secondColor" href="{{ route('featureCsvSample') }}" download>Download Sample</a> 
                            </div>
                        </div> 
                    </div>
                </div>
                            ...
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade show active" id="instruction" role="tabpanel" aria-labelledby="instruction-tab">
                                    <div class="col_inst" id="col_ins">
                                        ...
                                        <p class="  alert-danger rounded p-1">Blank box for = Cross</p>
                                        <p class="   alert-success rounded p-1">Write "Active" for = Check</p> 
                                        <div class="instruction_list">
													<div class="instruction_items">
														...
														<div class="d-flex instruction_list_items"><span class="font-weight-bold">2.</span> <span><strong>Heading <sup style="font-size:11px;color:red;">*</sup> : </strong><small>(Alphanumeric)</small></span></div>
														<div class="d-flex instruction_list_items"><span class="font-weight-bold">3.</span> <span><strong>Sub Heading <sup style="font-size:11px;color:red;">*</sup> : </strong><small>(Alphanumeric)</small></span></div>
														<div class="d-flex instruction_list_items"><span class="font-weight-bold">4.</span><span><strong>Lite <sup style="font-size:11px;color:red;">*</sup> : </strong><small>(Alphanumeric/Numeric/Blank)</small></span></div>
														<div class="d-flex instruction_list_items"><span class="font-weight-bold">5.</span> <span><strong>Standard <sup style="font-size:11px;color:red;">*</sup> : </strong><small>(Alphanumeric/Numeric/Blank)</small></span></div>
													</div>
													<div class="instruction_items">
														<div class="d-flex instruction_list_items"><span class="font-weight-bold">6.</span> <span><strong>Advance <sup style="font-size:11px;color:red;">*</sup> : </strong><small>(Alphanumeric/Numeric/Blank)</small></span></div>
														<div class="d-flex instruction_list_items"><span class="font-weight-bold">7.</span><span><strong>Enterprise <sup style="font-size:11px;color:red;">*</sup> : </strong><small>(Alphanumeric/Numeric/Blank)</small></span></div>
														<!--<div class="d-flex instruction_list_items"><span class="font-weight-bold">8.</span> <span><strong>Quantity <sup style="font-size:11px;color:red;">*</sup> : </strong><small>(Numeric values only)</small></span></div>-->
														<!--<div class="d-flex instruction_list_items"><span class="font-weight-bold">9.</span> <span><strong>Total Sqft <sup style="font-size:11px;color:red;">*</sup> : </strong><small>(Numeric &amp; Decimal values only)</small></span></div>-->
														<!--<div class="d-flex instruction_list_items"><span class="font-weight-bold">10.</span> <span><strong>Illumination Type <sup style="font-size:11px;color:red;">*</sup> : </strong><small>(Alphanumeric)</small></span></div>-->
													</div>
													<!--<div class="instruction_items d-none">-->
													<!--	<div class="d-flex instruction_list_items"><span class="font-weight-bold">11.</span> <span><strong>Rental Month <sup style="font-size:11px;color:red;">*</sup> : </strong><small>(Alphabets only)</small></span></div>-->
													<!--	<div class="d-flex instruction_list_items"><span class="font-weight-bold">12.</span> <span><strong>Rental Amount <sup style="font-size:11px;color:red;">*</sup> : </strong><small>(Numeric &amp; Decimal values only)</small></span></div> -->
													<!--	<div class="d-flex instruction_list_items"><span class="font-weight-bold">13.</span><span><strong>Mounting Amount <sup style="font-size:11px;color:red;">*</sup> : </strong><small>(Numeric &amp; Decimal values only)</small></span></div>-->
													<!--	<div class="d-flex instruction_list_items"><span class="font-weight-bold">14.</span><span><strong>Printing Amoun <sup style="font-size:11px;color:red;">*</sup> : </strong><small>(Numeric &amp; Decimal values only)</small></span></div>  -->
													<!--	<div class="d-flex instruction_list_items"><span class="font-weight-bold">15.</span><span><strong>Site Name <sup style="font-size:11px;color:red;">*</sup> : </strong><small>(Alphanumeric)</small></span></div>  -->
													<!--</div>  -->
												</div>
                                    </div>
                                </div>
