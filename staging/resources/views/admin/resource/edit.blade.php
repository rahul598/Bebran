...
@endphp
  <!-- Content Header (Resource header) -->
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">{{ __('Edit Resource') }}</h1>
        </div>
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="{{url('admin')}}">{{ __('Home') }}</a></li>
            <li class="breadcrumb-item active">{{ __('Edit Resource') }}</li>
          </ol>
        </div>
      </div>
    </div>
      ...
      <div class="col-md-12">
        ...
        <div class="card card-primary">
          ...
          <form role="form" action="{{ url(Admin_Prefix.'page/update/') }}"  method="post" enctype="multipart/form-data" class="customValidate">
            ...
            <input type="hidden" name="page_template" value="12">
                    ...
                    if($page->image2 && File::exists(public_path('uploads/'.$page->image2)) )
                      {
                        ...
                        <!-- <a href="{{ asset('/uploads/'.$page->image2) }}" data-fancybox><i class="fa fa-fw fa-eye"></i></a> --> <a href="{{ url(Admin_Prefix.'page-extra/content-delete/bannervideo/'.$page->id) }}" data-confirm="You want to delete this video!"><i class="fa fa-fw fa-window-close"></i></a>
                        <?php
                      }
                      ?>
                    </div>
                      ...
                      <div class="col-sm-10">
                        ...
                        <div class="clearfix">
                          ...
                          if($val->image && File::exists(public_path('uploads/'.$val->image)) )
                            {
                              ?>
                              <img src="{{ asset('/uploads/'.$val->image) }}" style="margin: 10px 0 0 0;max-width: 200px;"> <a href="{{ url('page-extra/content-delete/image/'.$val->id) }}" data-confirm="You want to delete this image!"><i class="fa fa-window-close"></i></a>
                          <?php
                            }
                          ?>
                        </div>
                      ...
                      <div class="col-sm-10">
                        ...
                        <div class="clearfix">
                          ...
                          if($val->image2 && File::exists(public_path('uploads/'.$val->image2)) ){
                              ?>
                              <img src="{{ asset('/timthumb.php') }}?src={{ asset('/uploads/'.$val->image2.'&w=95&h=95&zc=3') }}" style="margin: 10px 0 0 0;"> <a href="{{ url('page-extra/content-delete/image2/'.$val->id) }}" data-confirm="You want to delete this image!"><i class="fa fa-window-close"></i></a>
                          <?php
                            }
                          ?>
                        </div>
                      ...
                      <div class="{{$val->section_type==3?'col-sm-8':'col-sm-10'}}">
                        ...
                        <div class="clearfix">
                          ...
                          if($val->image && File::exists(public_path('uploads/'.$val->image)) )
                            {
                              ?>
                              <img src="{{ asset('/uploads/'.$val->image) }}" style="margin: 10px 0 0 0;max-width: 200px;"> <a href="{{ url('page-extra/content-delete/image/'.$val->id) }}" data-confirm="You want to delete this slider!"><i class="fa fa-window-close"></i></a>
                          <?php
                            }
                          ?>
                        </div>
