    ...
    <div class="row"> 
      ...
      <div class="col-md-12">
        ...
        <div class="px-3 py-4 border-bottom-2">
            <form action="{{ route('updateTitleTools', $component_content->id) }}" method="POST">
            @csrf
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control summernote"  name="content_body">{!! $component_content->body !!}</textarea> 
                </div>
                <button type="submit" class="btn btn-primary">Update Tools Content</button>
        </form>
        </div>
        </div>
        <!-- /.card -->
          ...
          <?php $row = 1 ; ?>
           ...
           <tr>
               <td>{{ $row++ }}</td>
                ...
                <td>
                    <form id="form_{{ $list->id }}" action="{{ route('updateDeleteToggleTools', ['id' => $list->id]) }}" method="post" enctype="multipart/form-data">
                        @csrf
...
<!-----------------model----------------->
 <form class="form-control" action="{{ route('storeFormDataTools') }}" method="POST" enctype="multipart/form-data">
     @csrf
