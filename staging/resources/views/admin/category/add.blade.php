...
if(old('rank')>0)
{
  ...
  $header_menu = get_fields_value_where('category',"id>0",'rank','desc');
    ...
    <div class="row"> 
      <div class="col-md-12">
        ...
        <div class="card card-primary">
          ...
          <!-- /.card-header -->
          <!-- form start -->
          <form role="form" action="{{ url(Admin_Prefix.'category/add/') }}"  method="post" enctype="multipart/form-data" class="customValidate">
