          ...
          <form role="form" action="{{ url(Admin_Prefix.'page/update/') }}"  method="post" enctype="multipart/form-data" class="customValidate">
            ...
            <div class="card-body">
              ...
              <div class="form-group row clearfix">
                ...
                <div class="col-sm-10">  
                    <input type="text" class="form-control" id="redirect_to" name="redirect_to" value="{{ ($page->redirect_to == null)?'No Redirection':$page->redirect_to}}">
                </div>
              </div>
              ...
              <div class="form-group row clearfix">
                ...
                @foreach($page_extra as $val)
                  ...
                  <div class="card-header with-border" style="margin-bottom: 15px;">
                    <h3 class="card-title {{$val->type}}">Section
                      {{-- @if($val->type==6 && $page->id=='1') {{$type_count}} Boxes
                        ...
                        @elseif($page->page_template=='4') FAQ
                        @else  --}}
                        @php($type_count++)
                        {{$type_count}} 
                        {{-- @endif  --}}
                  ...
                  @endif
                  @if($val->section_type==8 || $val->section_type==10 || $val->section_type==11 || $val->section_type==12 || $val->section_type==14 || $val->section_type==15 || $val->section_type==16 || $val->section_type==17 || $val->section_type==18 || $val->section_type==19 || $val->section_type==20 || ($val->section_type==1))
                    <div class="form-group row clearfix">
                  ...
                  @endif
                  @if($val->section_type==10 || $val->section_type==11 || $val->section_type==12 || $val->section_type==16 || $val->section_type==17 || $val->section_type==18 || $val->section_type==19 || $val->section_type==21)
                    <div class="form-group row clearfix">
