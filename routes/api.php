...
Route::get('/main-menu', [SiteController::class, 'getMainMenu']);
Route::get('/mega-menu', [SiteController::class, 'getMegaMenu']);
Route::get('/cart', [SiteController::class, 'getCartItems']);
Route::get('/footer-info', [SiteController::class, 'getFooterInfo']);


Route::get('/countries', [SiteController::class, 'getCountries']);
Route::get('/cities', [SiteController::class, 'getCities']);
Route::get('/businesses', [SiteController::class, 'getBusinesses']);
Route::get('/footer-assets', [SiteController::class, 'getFooterAssets']);
Route::get('page/{slug}', [SiteController::class, 'showPage']);
