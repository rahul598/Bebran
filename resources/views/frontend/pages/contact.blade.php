            ...
            <div class="col-lg-5 contact_rightbox order-1">
               <div class="contact_rightboxinner">
                  ...
                  <div class="media">
                     ...
                     <div class="media-body">
                        <h5>{{ $third_title }}</h5>
                        <p><a href="tel:918349815741">{{ $third_sub_title }}</a></p>
                     </div>
                  </div>
                  <div class="media">
                     ...
                     <div class="media-body">
                        <h5>{{ $fourth_title }}</h5>
                        <p><a href="mailto:{{ $fourth_sub_title }}">{{ $fourth_sub_title }}</a></p>
                     </div>
                  </div>
                  <div class="media">
                     ...
                     <div class="media-body">
                        <h5>{{ $fifth_title }}</h5>
                        <p><a href="https://wa.me/918349815741?text=Hello%20there!">{{ $fifth_sub_title }}</a></p>
                     </div>
                  </div>
               </div>
            </div>
