...
.casestudytab .portfoliosection .seoLandingBox{
...
<div class="service-inner-banner digital-marketing case-study-banner" style="background: url({{ (!empty($first_image) && file_exists(public_img_path($first_image))) ? asset('uploads/' . $first_image) : 'Image not found' }});">
    ...
    <div class="container">
      <div class="service-inner-body d-md-flex justify-content-between align-items-center">
        <div class="seotext">
            <h1 class="title_new">@if(!empty($first_title)) {!! $first_title !!}@endif</h1>
        </div>
    ...
    <div class="container">
        <div class="casestudytab">
            {{-- <nav class="nav nav-tabs justify-content-center" id="nav-tab" role="tablist">
                <a class="nav-link active" data-bs-toggle="tab" href="#allcasestudies" role="tab" aria-selected="true">All Media Coverage</a>
        
                @foreach($mediaCoverageCategoryData as $key => $category)
            ...
            <div class="tab-content" id="nav-tabContent1">
                <div class="tab-pane fade active show" id="allcasestudies" role="tabpanel">
                    ...
                    <div class="row">
                        @foreach($mediaCoverageCategoryData as $key => $study)
...
<!--------------ourclient video ------------------> 
 ...
 <div class="review">
  <div class="container">
     ...
     <!--<script type="text/javascript" src="https://widget.clutch.co/static/js/widget.js"></script> <div class="clutch-widget" data-url="https://widget.clutch.co" data-widget-type="2" data-height="45" data-nofollow="true" data-expandifr="true" data-scale="100" data-clutchcompany-id="2247200"></div>-->
     <div class="embedsocial-widget" data-ref="1f9e49d7873f36e6911fb27af74ef6ea"> 
     ...
     <img src="https://embedsocial.com/cdn/icon/embedsocial-logo.webp" alt="EmbedSocial" > <span> Google reviews widget </span> 
     </a> 
     </div> 
     ...
     <script type="text/javascript" src="https://widget.clutch.co/static/js/widget.js"></script> <div class="clutch-widget" data-url="https://widget.clutch.co" data-widget-type="2" data-height="45" data-nofollow="true" data-expandifr="true" data-scale="100" data-clutchcompany-id="2247200"></div>
     <div  style='width:auto;height:auto;'><iframe src='https://www.mouthshut.com/widget/review_widget.aspx?cid=926177791&laytyp=1&cp=1&svr=hide&spr=hide&swr=hide&mr=0&rIds=&rt=0&c=5' width='490' height='197' > </iframe></div>
     <div class="taggbox"  style="width:100%;height:100%" data-widget-id="163036" data-tags="false" ></div><script src="https://widget.taggbox.com/embed-lite.min.js" type="text/javascript"></script>
  </div>
