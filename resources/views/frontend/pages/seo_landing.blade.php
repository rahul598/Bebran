      ...
      <div class="container">
        ...
        <ul class="nav nav-tabs justify-content-center result_tab" style="margin-bottom:10%;border: none !important;" role="tablist">
            ...
            <li class="nav-item" role="presentation">
                <div class="text-dark rounded nav-link active border-0" id="tab-all" data-bs-toggle="tab" href="#content-all" role="tab" aria-controls="content-all" aria-selected="true">
                    All
                </div>
            </li>
            @foreach ($seo_category as $index => $category)
                <li class="nav-item" role="presentation">
                    <div class="text-dark  nav-link rounded" id="tab-{{ $category->id }}" data-bs-toggle="tab" href="#content-{{ $category->id }}" role="tab" aria-controls="content-{{ $category->id }}" aria-selected="{{ $index === 0 ? 'true' : 'false' }}">
                        {{ $category->name }}
                    </div>
                </li>
            @endforeach
...
<div class="seolanding-area" id="rsult_new">
    <div class="innerbanner-area">
        <nav class="breadcrumb bg_acc_new">
            <div class="container">
                <a class="breadcrumb-item" style="font-weight:700;" href="{{ url('/') }}">home</a>
                <span class="breadcrumb-item active"><span class="span">{{ $page->page_name }}</span></span>
            </div>
        </nav>
    </div>
    <div class="container">
    ...
    <ul class="nav nav-tabs justify-content-center result_tab" style="margin-bottom:10%;border: none !important;" role="tablist">
        <li class="nav-item" role="presentation" style="margin: 5px 0;">
            <div class="category_tab text-dark rounded nav-link active border-0" data-category="all">
                All
            </div>
        </li>
        @foreach ($seo_category as $index => $category)
            <li class="nav-item" role="presentation" style="margin: 5px 0;">
                <div class="category_tab text-dark rounded nav-link" data-category="{{ $category->id }}">
                    {{ $category->name }}
                </div>
            </li>
        @endforeach
...
<div class="seocampaigns-area bg_acc_new">
    <div class="container">
        <div class="seocampaigns-body">
            <div class="headingbox">
                <h2 class="pb-3">@if(!empty($fifth_title)) {{ $fifth_title }}@endif<br><strong>@if(!empty($fifth_sub_title)) {{ $fifth_sub_title }}@endif</strong></h2>
            </div>
                            ...
                            resultsContainer.append(`
                                <div class="col mb-4">
                                    <div class="card seoLandingBox">
                                        ...
                                        <div class="card-body">
                                            <div class="slider_h4">${result.page_title}</div>
                                            ...
                                            <div class="d-flex align-items-center seoLandingBoxCountry">
                                                ...
                                                <div class="flex-grow-1 media-body">
                                                    <div class="flex-grow-1_h5">${result.bannertext}</div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="card-footer">
                                            <div class="searchPercent d-flex align-items-center justify-content-center">
                                                <div class="percen_h5">${result.author_url}</div>
                                            </div>
