    ...
    <div class="card-body"> 
        <div id="toc1"> 
            ...
            <div class="details-table-box card">
              <div class="card-header d-none" id="{{ $value->id }}">
            ...
            <div class="blog-details-social2 card">
              <div class="card-body d-flex justify-content-between">
                  <ul class="social d-flex">
                    <li>Author :</li>
                    <li>{{$blog_details[0]->page_title}}</li>
        ...
        <div class="col-xxl-4 col-xxl-4 col-lg-4 col-md-4 position-relative">
          <div class="blog-listing-filter-area sidebar_sticky">
            <div class="blog-listing-form card">
              <div class="card-body">
                <h3>Let’s Contact</h3>
                <form method="post" action="{{ url('blog-form') }}" class="blogForm blogForm_details" id="blogForm" autocomplete="off">
                    @csrf
                    @if (session('success'))
                          <div class="alert alert-success">
                            {{ session('success') }}
                    ...
                    <div class="form-group">
                      ...
                      <input type="number" class="form-control mobile_code" id="mobile_code_new" name="phone" oninput="if (this.value.length > 10) { this.value = this.value.slice(0, 10); }" placeholder="Mobile Number *"  >
                      @if ($errors->has('phone'))
                      <span class="text-danger">{{ $errors->first('phone') }}</span>
                      @endif
...
$(document).ready(function() {
  ...
  <script>
    ...
    <script>
     $(document).ready(function () {
    // Function to remove error message when a field changes
    ...
    // Call removeErrorOnChange for each field
    ...
    $(document).on('submit', '.blogForm_details', function (e) {
        e.preventDefault();
