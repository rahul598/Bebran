...
@section('more-css')
<style>
.consectetur .tab-content .tab-pane h3 {
    font-size: 30px;
    font-weight: 600;
    color: #033355;
...
@media only screen and (max-width: 768px) {
    .helpyouarea .Whatwedo_thumble {
        position: relative;
        width: 100%; /* Full width on mobile */
        padding-bottom: calc(100% / (606 / 384)); /* Maintain 1.58 aspect ratio (606/384) */
        overflow: hidden;
    }

    .helpyouarea .Whatwedo_thumble img.helpImg {
        position: absolute;
        top: 0;
        left: 0;
        width: 100%;
...
@endphp
    ...
    <section class="about-area pt-90 low_height bg_acc_new" id="about" >
  <div class="container">
        ...
        <div class="helpyouarea">
          <div class="Whatwedo_box row">
            <div class="col-lg-6 col-md-6 Whatwedoimg d-flex flex-wrap align-content-stretch">
              <div class="Whatwedo_thumble d-flex"> <img class="helpImg" src="{{ asset('uploads/'.$fifth_image) }}" alt="{{ getImageNameAlt($fifth_image) }}" width="606" height="385">
                <div class="helpicon">
                    <img src="{{ asset('uploads/'.$fifth_image2) }}" alt="{{ getImageNameAlt($fifth_image2) }}" >
                    </div>
              </div>
            </div>
          ...
          <div class="Whatwedo_box row">
            <div class="col-lg-6 col-md-6 Whatwedoimg d-flex flex-wrap align-content-stretch">
              <div class="Whatwedo_thumble d-flex"> <img class="helpImg"  src="{{ asset('uploads/'.$sixth_image) }}" alt="{{ getImageNameAlt($sixth_image) }}" width="606" height="385">
                <div class="helpicon"><img class="" src="{{ asset('uploads/'.$sixth_image2) }}" alt="{{ getImageNameAlt($sixth_image2) }}" ></div>
              </div>
            </div>
            <div class="col-lg-6 col-md-6 Whatwedocontent d-flex flex-wrap align-content-stretch align-items-center">
              <div class="Whatwedo_textbox">
        ...
        <div class="row wus">
          ...
          <div class="col-lg-6 digitxt p-0">
            <div class="whyr" style="background:url({{ asset('uploads/'.$ninth_image2) }}) center no-repeat">
              ...
              <p class="normal_text">Professional </p>
              <div class="digital_h4"> Digital Marketing</div>
              <div class="digital_h5">Firm</div>
        ...
        <div class="row us">
          <div class="col-lg-6 p-0 digitxt">
            <div class="whyle" style="background:url({{ asset('uploads/'.$tenth_image2) }}) center no-repeat">
              <div class="whyle_h6">{!! $tenth_title !!}</div>
              <div class="whyle_h4">marketing</div>
              <div class="whyle_h5">consultants</div>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="form-group">
                <label class="body_form_label">Name</label>
        ...
        <div class="col-lg-6">
            <div class="form-group">
                <label class="body_form_label">Phone</label>
                <input type="number" class="form-control mobile_code" id="mobile_code" data-intl-tel-input-id="0" oninput="if (this.value.length > 10) { this.value = this.value.slice(0, 10); }" name="phone" placeholder="Phone"  value="">
                @if ($errors->has('phone'))
        ...
        <div class="col-lg-6">
            <div class="form-group">
                <label class="body_form_label">Select Service<select class="form-control" name="serviceName"  aria-labelledby="serviceLabel">
        ...
        <div class="col-lg-12">
            <div class="form-group">
                <label class="body_form_label">Budget</label>
        ...
        <div class="col-lg-12">
            <div class="form-group">
                <label class="body_form_label">Website Url</label>
    ...
    <div class="consectetur bg_acc_new">
      <div class="container">
        <div class="headingbox text-center ">
