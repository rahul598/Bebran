...
.nav-pills .nav-link{box-shadow: 0px 2px 20px rgba(0, 0, 0, 30%);margin: 0 1px;}
...
.dropdown.packages .m-c_h5 span{font-size: 34px;}
sup.currency {
    top: -15px;
    left: 13px;
    font-size: 30px;
...
.dropdown.packages .m-c_h5 del{font-size: 15px;}
...
@media(max-width:767px){
   ...
   /*.price_card_figma .row{*/
   /* overflow: scroll;*/
   /* flex-wrap: nowrap;       */
   /*}*/
   /*.price_card_figma .col{*/
   /*    max-width: 400px;*/
   /*}*/
                                        ...
                                        <div class="mb-1">
                                            @if($discount_price < $main_price)
                                                <div class="d-flex justify-content-center align-items-center mb-2">
                                                    <div>
                                                        <del>₹{{ number_format($main_price, 0, '.', '') }}</del>
                                                    </div>
                                                    @if($percentage > 0)
                                                    <div class="off-button-wrapper ml-3">
                                                        <div class="off-button">
                                                            <div class="off-button-child"></div>
                                                            <div class="off f-14 f-n">{{ number_format($percentage, 0, '.', '') }}% Off</div>
                                                        </div>
                                                    </div>
                                                    @endif  
                                                </div>
                                                <div>
                                                    ...
                                                    <span>{{ number_format($discount_price, 0, '.', '') }}</span>
                                                    <sub>/ mo</sub>
                                                </div>
                                            @else
                                                <span><sup class="currency">₹</sup></span>
                                                <span>{{ number_format($main_price, 0, '.', '') }}</span>
                                                <sub>/ mo</sub>
                                            @endif
                                        </div>
                                    </div>
