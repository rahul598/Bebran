         ...
         <input class="form-control service" type="text" name="service" value="{{ $service->page_name }}" readonly disabled />
          ...
          <nav>
                    <div class="nav nav-tabs" id="nav-tab" role="tablist">
                      ...
                      <button class="nav-link" id="nav-addon-tab" data-toggle="tab" data-target="#nav-addon" type="button" role="tab" aria-controls="nav-profile" aria-selected="false">Addon's</button>
                ...
                <div class="tab-content p-3 border-0 bg-light" id="nav-tabContent">
                    ...
                    <div class="tab-pane fade" id="nav-addon" role="tabpanel" aria-labelledby="nav-addon-tab">
