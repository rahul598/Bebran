...
@section('content')
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">{{ __('Edit Package Type') }}</h1>
        </div>
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="{{url('admin')}}">{{ __('Home') }}</a></li>
            <li class="breadcrumb-item active">{{ __('Edit Package Type') }}</li>
          </ol>
        </div>
      </div>
    </div>
    ...
    <div class="row"> 
      <div class="col-md-12">
        <div class="card card-primary">
          ...
          <!-- /.card-header -->
          <!-- form start -->
          <form role="form" action="{{ url(Admin_Prefix.'package-type/update/') }}"  method="post" enctype="multipart/form-data" class="customValidate">
            @csrf
            ...
            <div class="card-body">
              ...
              <div class="form-group row clearfix">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control module_name" name="title" placeholder="Enter ..." value="{{ $list->title }}" required>
                </div>
              </div>
              ...
              <div class="form-group row clearfix">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" name="discount_title" id="discount_title" placeholder="Enter ..." value="{{ $list->discount_title }}">
                </div>
              </div>
              ...
              <div class="form-group row clearfix">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" name="discount_sub_title" id="discount_sub_title" placeholder="Enter ..." value="{{ $list->discount_sub_title }}">
                </div>
              </div>
              ...
              <div class="form-group row clearfix">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" name="button_txt" id="button_txt" placeholder="Enter ..." value="{{ $list->button_txt }}">
                </div>
              </div>
              ...
              <div class="form-group row clearfix">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" name="button_url" id="button_url" placeholder="Enter ..." value="{{ $list->button_url }}">
                </div>
              </div>
