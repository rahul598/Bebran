<nav class="mt-2">
  <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
    <li class="nav-item">
      <a href="{{ route('dashboard') }}" class="nav-link {{ (Request::is(Admin_Prefix) ? 'active' : '') }}">
    ...
    <!------------------- widget menu ---------------> 
    <li class="nav-item has-treeview {{ (Request::is(Admin_Prefix.'reviews')  || Request::is(Admin_Prefix.'our-strength') || Request::is(Admin_Prefix.'certified-digital-marketing-professionals') || Request::is(Admin_Prefix.'tools-we-use') || Request::is(Admin_Prefix.'our-partners') || Request::is(Admin_Prefix.'our-work-featured') || Request::is(Admin_Prefix.'video-testimonials') || Request::is(Admin_Prefix.'contact-form')? 'menu-open' : '') }}">
      <a href="javascript:void(0);" class="nav-link {{ (Request::is(Admin_Prefix.'our-strength') || Request::is(Admin_Prefix.'certified-digital-marketing-professionals') || Request::is(Admin_Prefix.'tools-we-use') || Request::is(Admin_Prefix.'our-partners') || Request::is(Admin_Prefix.'our-work-featured') || Request::is(Admin_Prefix.'video-testimonials') || Request::is(Admin_Prefix.'addon') || Request::is(Admin_Prefix.'addon-show') || Request::is(Admin_Prefix.'contact-form')? 'menu-open' : '') }}">
       ...
       <ul class="nav nav-treeview">
        <li class="nav-item">
          <a href="{{ url(Admin_Prefix.'our-strength') }}" class="nav-link {{ (Request::is(Admin_Prefix.'our-strength') ? 'active' : '') }}">
            <i class="far fa-circle nav-icon"></i>
            <p>Our strength</p>
          </a>
        </li> 
        <li class="nav-item">
          <a href="{{ url(Admin_Prefix.'certified-digital-marketing-professionals') }}" class="nav-link {{ (Request::is(Admin_Prefix.'certified-digital-marketing-professionals') ? 'active' : '') }}">
            <i class="far fa-circle nav-icon"></i>
            <p>Certified Professionals</p>
          </a>
        </li> 
        <li class="nav-item">
          <a href="{{ url(Admin_Prefix.'tools-we-use') }}" class="nav-link {{ (Request::is(Admin_Prefix.'tools-we-use') ? 'active' : '') }}">
            <i class="far fa-circle nav-icon"></i>
            <p>Tools We Use</p>
          </a>
        </li> 
        <li class="nav-item">
          <a href="{{ url(Admin_Prefix.'our-partners') }}" class="nav-link {{ (Request::is(Admin_Prefix.'our-partners') ? 'active' : '') }}">
            <i class="far fa-circle nav-icon"></i>
            <p>Our Partners</p>
          </a>
        </li> 
        <li class="nav-item">
          <a href="{{ url(Admin_Prefix.'our-work-featured') }}" class="nav-link {{ (Request::is(Admin_Prefix.'our-work-featured') ? 'active' : '') }}">
            <i class="far fa-circle nav-icon"></i>
            <p>Our Work Featured on</p>
          </a>
        </li> 
        <li class="nav-item">
          <a href="{{ url(Admin_Prefix.'video-testimonials') }}" class="nav-link {{ (Request::is(Admin_Prefix.'video-testimonials') ? 'active' : '') }}">
            <i class="far fa-circle nav-icon"></i>
            <p>Video Testimonials</p>
          </a>
        </li>   
        <li class="nav-item">
          <a href="{{ url(Admin_Prefix.'reviews') }}" class="nav-link {{ (Request::is(Admin_Prefix.'reviews') ? 'active' : '') }}">
            <i class="far fa-circle nav-icon"></i>
            <p>Reviews</p>
          </a>
        </li>   
        <li class="nav-item">
          <a href=" {{url(Admin_Prefix.'addon-show')}}" class="nav-link  ">
            <i class="far fa-circle nav-icon"></i>
            <p>Add on's</p>
          </a> 
        </li>   
    ...
    <!-- Pricing Plan Packages -->
          <li class="d-none nav-item has-treeview {{ (Request::is(Admin_Prefix.'package-category') || Request::is(Admin_Prefix.'package-category/add') || Request::is(Admin_Prefix.'package-category/edit/*') || Request::is(Admin_Prefix.'package-type') || Request::is(Admin_Prefix.'package-type/add') || Request::is(Admin_Prefix.'package-type/edit/*')
    ...
    <!-- Pricing Plan -->
    <!-- OUR WORK -->
    <li class="nav-item has-treeview {{ (Request::is(Admin_Prefix.'seo-landing') || Request::is(Admin_Prefix.'seo-landing/add') || Request::is(Admin_Prefix.'case-study') || Request::is(Admin_Prefix.'case-study/add') || Request::is(Admin_Prefix.'caseStudiesCategory') || Request::is(Admin_Prefix.'portfolio') || Request::is(Admin_Prefix.'portfolio/add') || Request::is(Admin_Prefix.'portfolio/edit/*') || Request::is(Admin_Prefix.'portfolioCategory') || Request::is(Admin_Prefix.'portfolioCategory/add') || Request::is(Admin_Prefix.'portfolioCategory/edit/*') || Request::is(Admin_Prefix.'sample') || Request::is(Admin_Prefix.'sample/add') || Request::is(Admin_Prefix.'sample/edit/*') || Request::is(Admin_Prefix.'sampleCategory') || Request::is(Admin_Prefix.'sampleCategory/add') || Request::is(Admin_Prefix.'sampleCategory/edit/*') || Request::is(Admin_Prefix.'mediaCoverage') || Request::is(Admin_Prefix.'mediaCoverage/add') || Request::is(Admin_Prefix.'mediaCoverage/edit/*') || Request::is(Admin_Prefix.'mediaCoverageCategory') || Request::is(Admin_Prefix.'mediaCoverageCategory/add') || Request::is(Admin_Prefix.'mediaCoverageCategory/edit/*') || Request::is(Admin_Prefix.'seoResultCategory') || Request::is(Admin_Prefix.'seo-landing/edit/*') ? 'menu-open' : '') }}">
      ...
      <ul class="nav nav-treeview">
        <li class="nav-item has-treeview {{ (Request::is(Admin_Prefix.'seo-result-landing') || Request::is(Admin_Prefix.'seo-landing') || Request::is(Admin_Prefix.'seo-landing/add')  || Request::is(Admin_Prefix.'seoResultCategory') || Request::is(Admin_Prefix.'seoResultCategory')? 'menu-open' : '') }}">
          <a href="javascript:void(0);" class="nav-link {{ (Request::is(Admin_Prefix.'seo-result-landing') || Request::is(Admin_Prefix.'seo-landing') || Request::is(Admin_Prefix.'seo-landing/add') || Request::is(Admin_Prefix.'seoResultCategory') || Request::is(Admin_Prefix.'seoResultCategory')? 'active' : '') }}">
          ...
          <li class="nav-item">
            ...
            <li class="nav-item">
              <a href="{{ url(Admin_Prefix.'seoResultCategory') }}" class="nav-link {{ (Request::is(Admin_Prefix.'seoResultCategory')? 'active' : '') }}">
                <i class="far fa-star nav-icon"></i>
                <p>Result Category</p>
              </a>
            </li>
    ...
    {{-- <li class="nav-item has-treeview active">
     ...
     <li class="nav-item has-treeview {{ 
            Request::is(Admin_Prefix.'slider-form-list') || 
            Request::is(Admin_Prefix.'body-form-list') || 
            Request::is(Admin_Prefix.'blog-form-list') || 
            Request::is(Admin_Prefix.'contact-form-list') || 
            Request::is(Admin_Prefix.'form-list') || 
            Request::is(Admin_Prefix.'guest-forms-data') || 
            Request::is(Admin_Prefix.'service-form') || 
            Request::is(Admin_Prefix.'contact_us') ||
            Request::is(Admin_Prefix.'sign_up') || 
            Request::is(Admin_Prefix.'tracking-code') || 
            Request::is(Admin_Prefix.'purchase') 
            ? 'menu-open' : '' 
        }}">

      <a href="javascript:void(0);" class="nav-link {{ (Request::is(Admin_Prefix.'tracking-code') || Request::is(Admin_Prefix.'purchase') || Request::is(Admin_Prefix.'sign_up') || Request::is(Admin_Prefix.'form-list') || Request::is(Admin_Prefix.'guest-forms-data') || Request::is(Admin_Prefix.'home-form') || Request::is(Admin_Prefix.'service-form') || Request::is(Admin_Prefix.'contact_us') || Request::is(Admin_Prefix.'guest-forms-data') ? 'active' : '') }}">
        <i class="nav-icon fas fa-list"></i>
        <p>
          Enquiry Section
          <i class="fas fa-angle-left right"></i>
      ...
      <ul class="nav nav-treeview">
        <li class="nav-item">
          <a href="{{ url(Admin_Prefix.'form-list') }}" class="d-none nav-link {{ (Request::is(Admin_Prefix.'form-list') ? 'active' : '') }}">
            <i class="far fa-star nav-icon"></i>
            <p>Enquiry Forms</p>
          </a>
        </li>
        <li class="nav-item">
          <a href="{{ url(Admin_Prefix.'contact-form-list') }}" class="nav-link {{ (Request::is(Admin_Prefix.'contact-form-list') ? 'active' : '') }}">
            <i class="far fa-star nav-icon"></i>
            <p>Contact Form</p>
          </a>
        </li>
        <li class="nav-item">
          <a href="{{ url(Admin_Prefix.'blog-form-list') }}" class="nav-link {{ (Request::is(Admin_Prefix.'blog-form-list') ? 'active' : '') }}">
            <i class="far fa-star nav-icon"></i>
            <p>Blog Form</p>
          </a>
        </li>
        <li class="nav-item">
          <a href="{{ url(Admin_Prefix.'body-form-list') }}" class="nav-link {{ (Request::is(Admin_Prefix.'body-form-list') ? 'active' : '') }}">
            <i class="far fa-star nav-icon"></i>
            <p>Body Form</p>
          </a>
        </li>
        <li class="nav-item">
          <a href="{{ url(Admin_Prefix.'slider-form-list') }}" class="nav-link {{ (Request::is(Admin_Prefix.'slider-form-list') ? 'active' : '') }}">
            <i class="far fa-star nav-icon"></i>
            <p>Slider Form</p>
          </a>
        </li>
        ...
        <li class="nav-item">
          <a href="{{ url(Admin_Prefix.'tracking-code') }}" class="nav-link">
            <i class="far fa-star nav-icon"></i>
            <p>Form Tracking Code</p>
          </a>
        </li> 
        <li class="nav-item has-treeview {{ (Request::is(Admin_Prefix.'sign_up') || Request::is(Admin_Prefix.'purchase')  ? 'menu-open' : '') }}">
          <a href="javascript:void(0);" class="nav-link {{ (Request::is(Admin_Prefix.'sign_up') || Request::is(Admin_Prefix.'purchase') ? 'active' : '') }}">
            <i class="far fa-folder-open"></i>
            <p>
              Conversions
              <i class="fas fa-angle-left right"></i>
          ...
          <ul class="nav nav-treeview">
            <li class="nav-item">
              <a href="{{ url(Admin_Prefix.'sign_up') }}" class="nav-link {{ (Request::is(Admin_Prefix.'sign_up') ? 'active' : '') }}">
                <i class="far fa-star nav-icon"></i>
                <p>Purchase Data </p>
              </a>
            </li> 
            <li class="nav-item">
              <a href="{{ url(Admin_Prefix.'purchase') }}" class="nav-link {{ (Request::is(Admin_Prefix.'purchase') ? 'active' : '') }}">
                <i class="far fa-star nav-icon"></i>
                <p>Sign Up Data</p>
              </a>
            </li> 
    ...
    <li class="nav-item has-treeview {{ (Request::is(Admin_Prefix.'clients')  ? 'menu-open' : '') }}">
      <a href="javascript:void(0);" class="nav-link {{ (Request::is(Admin_Prefix.'clients') ? 'active' : '') }}">
        <i class="nav-icon fas fa-list"></i>
        <p>
         Clients 
          <i class="fas fa-angle-left right"></i>
      ...
      <ul class="nav nav-treeview">
        <li class="nav-item">
          <a href="{{ url(Admin_Prefix.'clients') }}" class="nav-link {{ (Request::is(Admin_Prefix.'clients') ? 'active' : '') }}">
            <i class="far fa-star nav-icon"></i>
            <p>Client List</p>
          </a>
        </li> 
