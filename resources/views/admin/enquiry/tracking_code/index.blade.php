           ...
           <tr>
               ...
               <td>
                    <select class="form-control" name="page_placement" form="form_{{ $list->id }}">
                        ...
                        <option value="sign_up_page" {{ $list->page_placement == 'sign_up_page' ? 'selected' : '' }}>Thank Page for Sign Up Page</option>
                        <option value="purchase_page" {{ $list->page_placement == 'purchase_page' ? 'selected' : '' }}>Thank Page for Purchase Page</option>
                    </select>
