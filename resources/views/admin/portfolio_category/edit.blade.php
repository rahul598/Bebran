...
@section('content')
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">{{ __('Edit Portfolio Category') }}</h1>
        </div>
        <div class="col-sm-6">
    ...
    <div class="row"> 
      <div class="col-md-12">
        ...
        <div class="card card-primary">
          ...
          <!-- /.card-header -->
          <!-- form start -->
          <form role="form" action="{{ url(Admin_Prefix.'portfolioCategory/update/') }}"  method="post" enctype="multipart/form-data" class="customValidate">
