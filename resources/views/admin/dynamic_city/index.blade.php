          ...
          <div class="card-body table-responsive">
            ...
            <table id="example2" class="table table-bordered table-hover dataTable">
              ...
              @endif
                  @endforeach
                  <td width="170">
                    <a href="{{ url(Admin_Prefix.'city-service/edit/'.$page->id) }}" title="Edit" class="btn btn-success"><i class="fa fa-fw fa-edit"></i></a>
                    ...
                    @if($page->id != City_Service_Page_ID && $page->id != Development_Page_ID)
