            ...
            <div class="card-body">
                  ...
                  <div class="col-sm-10">
                      <select name="service_id" class="form-control" data-placeholder="Select">
                          ...
                          @foreach($serviceData as $key => $value)
                              <option value="{!! $value->id !!}" @if(is_array($service_id) && in_array($value->id, $service_id)) selected @endif>{!! $value->page_name !!}</option>
                          @endforeach
                      </select>
                  </div>
              </div>
              ...
              <div class="form-group row clearfix bannerimage">
                ...
                <div class="form-group row clearfix">
                  ...
                  <div class="col-sm-10">
                    <textarea name="body" class="ckeditor" id="editor1" placeholder="Enter ...">{{ old('body') }}</textarea>
                  </div>
                </div>
