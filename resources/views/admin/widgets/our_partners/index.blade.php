...
@endphp
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">{{ __('Our Partners Widgets') }} <a href="{{ url(Admin_Prefix.'seoResultCategory/add') }}" class="btn btn-primary d-none">Add</a></h1>
        </div>
        <div class="col-sm-6">
    ...
    <div class="row"> 
      ...
      <div class="col-md-12">
        ...
        <div class="px-3 py-4 border-bottom-2">
            <form action="{{ route('updateTitlePartner', $component_content->id) }}" method="POST">
            @csrf
                <div class="mb-3">
                ...
                <button type="submit" name="submit" class="btn btn-primary">Update Our Partners Content</button>
        </form>
        </div>
        </div>
        <!-- /.card -->
          ...
          <?php $row = 1 ; ?>
           ...
           <tr>
               <td>{{ $row++ }}</td>
                ...
                <td>
                    <form id="form_{{ $list->id }}" action="{{ route('updateDeleteTogglePartner', ['id' => $list->id]) }}" method="post" enctype="multipart/form-data">
                        @csrf
...
<!-- /.content -->
<!-----------------model----------------->
 <form class="form-control" action="{{ route('storeFormDataPartner') }}" method="POST" enctype="multipart/form-data">
     @csrf
