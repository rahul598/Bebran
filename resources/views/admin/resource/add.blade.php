...
@endphp
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">{{ __('Add Resource') }}</h1>
        </div>
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="{{url('admin')}}">{{ __('Home') }}</a></li>
            <li class="breadcrumb-item active">{{ __('Add Resource') }}</li>
          </ol>
        </div>
      </div>
    </div>
              ...
              <div class="form-group row clearfix">
                ...
                <div class="col-sm-4">
                  <select name="parent_id" id="parent_id" class="form-control">
                    ...
                    <option value="{{$value->id}}" {!!old('parent_id')==$value->id?'selected':''!!}>{!! $value->page_name !!}</option>
                    @endforeach
                  </select>
                </div>
