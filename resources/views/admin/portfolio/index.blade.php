...
@endphp
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">{{ __('Portfolio') }} <a href="{{ url(Admin_Prefix.'portfolio/add') }}" class="btn btn-primary">Add</a></h1>
        </div>
        <div class="col-sm-6">
                ...
                <table id="example2" class="table table-bordered table-hover dataTable">
                  ...
                  @if ($lists->count() > 0)
                   ...
                   <tr>
                    ...
                    @endforeach
                    <td>
                      <a href="{{ url(Admin_Prefix.'portfolio/edit/'.$list->id) }}" title="Edit" class="btn btn-success"><i class="fa fa-fw fa-edit"></i></a>
