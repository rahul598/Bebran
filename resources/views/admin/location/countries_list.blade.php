...
<div class="content-header">
   <div class="container-fluid">
      <div class="row mb-2">
         <div class="col-sm-6">
            <h1 class="m-0 text-dark">{{ __('Countries') }} <a href="{{ url(Admin_Prefix.'countries/add') }}" class="btn btn-primary">Add</a></h1>
         </div>
         <div class="col-sm-6">
                  ...
                  <table id="example2" class="table table-bordered table-hover dataTable">
                     ...
                     <tbody>
                        ...
                        <tr>
                           ...
                           @endforeach
                           <td>
                              <a href="{{ url(Admin_Prefix.'countries/edit/'.$list->id) }}" title="Edit" class="btn btn-success"><i class="fa fa-fw fa-edit"></i></a>
                              <a href="{{ url(Admin_Prefix.'countries/delete/'.$list->id) }}" data-confirm="" title="Delete" class="btn btn-danger"><i class="fa fa-fw fa-window-close"></i></a>
                           </td>
                        </tr>
                        @endforeach
                        @else
