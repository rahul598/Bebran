...
@endphp
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">{{ __('Add Business Service') }}</h1>
        </div>
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="{{url('admin')}}">{{ __('Home') }}</a></li>
            <li class="breadcrumb-item active">{{ __('Add Business Service') }}</li>
          </ol>
        </div>
      </div>
    </div>
      ...
      <div class="col-md-12">
        ...
        <div class="card card-primary">
          <div class="card-header with-border">
            <h3 class="card-title">Add Business Service</h3>
          </div>
          <!-- /.card-header -->
          <!-- form start -->
          <form role="form" action="{{ url(Admin_Prefix.'business-service/add/') }}"  method="post" enctype="multipart/form-data" class="customValidate">
